            ...
            <nav className="bg-gray-700 p-4 relative z-10">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <div className="flex-1 flex justify-center space-x-4 text-lg">
                        ...
                        <Link to='/lockTokens' className="text-white bg-blue-500 hover:bg-blue-700 py-1 px-4 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-105">Lock & Unlock Tokens</Link>
                        <Link to='/claimWTokens' className="text-white bg-blue-500 hover:bg-blue-700 py-1 px-4 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-105">Claim & Burn W-Tokens</Link>
                    </div>
                    <div>
                        <Connectbutton />
                    </div>
